...
1. [GitHub private vulnerability reporting](https://github.com/StaticMania/docora/security/advisories/new)
2. Email [hello@staticmania.com](mailto:hello@staticmania.com) with the subject `Docora security report`
